...
export declare const getAssetType: (chain: Chain, ticker: string, isSynth?: boolean) => "Synth" | "Native" | "GAIA" | "BEP2" | "BEP20" | "ERC20" | "AVAX";
...
export declare const getSignatureAssetFor: (signature: Signature) => AssetEntity;
...
declare type Signature = Chain | 'USD' | 'ETH_THOR' | 'ETH_RUNE' | 'BNB_RUNE' | 'THOR';
